...
const cdn = form.data('cdn-url');
const publicKey = form.data('checkout-public-key');
const debug = form.data('checkout-debug');
const amount = form.data('checkout-transaction-value');
const csrf = form.data('checkout-csrf');
const url  = form.data('checkout-url');
const redirect = form.data('checkout-redirect');
const scode = form.data('checkout-scode');
