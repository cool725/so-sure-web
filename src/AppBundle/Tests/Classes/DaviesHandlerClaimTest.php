...
class DaviesHandlerClaimTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testClaimsType()
    {
        ...
        $this->assertEquals(70, $davies->getExpectedExcessValue(false, false));
        $this->assertEquals(70, $davies->getExpectedExcessValue(true, false));
        $this->assertEquals(70, $davies->getExpectedExcessValue(true, true));
        $this->assertEquals(150, $davies->getExpectedExcessValue(false, true));

        $davies->lossType = "Warranty - Audio Fault";
        $this->assertEquals(Claim::TYPE_WARRANTY, $davies->getClaimType());
        $this->assertEquals(50, $davies->getExpectedExcessValue(false, false));
        $this->assertEquals(50, $davies->getExpectedExcessValue(true, false));
        $this->assertEquals(50, $davies->getExpectedExcessValue(true, true));
        $this->assertEquals(150, $davies->getExpectedExcessValue(false, true));
