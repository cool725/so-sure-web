...
class GocardlessService
{
    ...
    public function createCustomer(User $user, $accountFirstName, $accountLastName, $idempotent = true)
    {
        ...
        $data = [
            ...
            "address_line1" => $billing ? $billing->getLine1() : null,
            "address_line2" => $billing ? $billing->getLine2() : null,
            "address_line3" => $billing ? $billing->getLine3() : null,
            "city" => $billing ? $billing->getCity() : null,
            "postal_code" => $billing ? $billing->getPostcode() : null,
            "country_code" => "GB",
            "metadata" => [
                "id" => $user->getId(),
            ]
