...
class DefaultController extends BaseController
{
     ...
     * @Route("/quote/{make}+{model}+{memory}+insurance", name="quote_make_model_memory", requirements={"make":"[a-zA-Z]+","model":"[\+\-a-zA-Z0-9() ]+","memory":"[0-9]+"})
     * @Route("/quote/{make}+{model}+insurance", name="quote_make_model", requirements={"make":"[a-zA-Z]+","model":"[\+\-a-zA-Z0-9() ]+"})
     * @Template
     */
