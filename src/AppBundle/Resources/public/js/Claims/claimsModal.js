            ...
            if (documents) {
                if (claim.needProofOfUsage) {
                    if (documents.proofOfUsages.length > 0) {
                        ...
                        $.each(documents.proofOfUsages, function(key, value) {
                            proofOfUsages += '<p>'+value.filename+' <img class="img-preview" src="'+value.url+'" /> <a href="'+value.url_download+'"><i class="fa fa-download"</a></p>';
                        });
                ...
                if (claim.needProofOfPurchase) {
                    if (documents.proofOfPurchases.length > 0) {
                        ...
                        $.each(documents.proofOfPurchases, function(key, value) {
                            proofOfPurchases += '<p>'+value.filename+' <img class="img-preview" src="'+value.url+'" /> <a href="'+value.url_download+'"><i class="fa fa-download"</a></p>';
                        });
                ...
                if (claim.needPictureOfPhone) {
                    if (documents.damagePictures.length > 0) {
                        ...
                        $.each(documents.damagePictures, function(key, value) {
                            damagePictures += '<p>'+value.filename+' <img class="img-preview" src="'+value.url+'" /> <a href="'+value.url_download+'"><i class="fa fa-download"</a></p>';
                        });
                ...
                if (documents.others.length > 0) {
                    ...
                    $.each(documents.others, function(key, value) {
                        others += '<p>'+value.filename+' <img class="img-preview" src="'+value.url+'" /> <a href="'+value.url_download+'"><i class="fa fa-download"</a></p>';
                    });
                ...
                if (claim.needProofOfBarring) {
                    if (documents.proofOfBarrings.length > 0) {
                        ...
                        $.each(documents.proofOfBarrings, function (key, value) {
                            proofOfBarrings += '<p>'+value.filename+' <img class="img-preview" src="'+value.url+'" /> <a href="'+value.url_download+'"><i class="fa fa-download"</a></p>';
                        });
                    ...
                    if (claim.needProofOfLoss) {
                        if (documents.proofOfLosses.length > 0) {
                            ...
                            $.each(documents.proofOfLosses, function(key, value) {
                                proofOfLosses += '<p>'+value.filename+' <img class="img-preview" src="'+value.url+'" /> <a href="'+value.url_download+'"><i class="fa fa-download"</a></p>';
                            });
