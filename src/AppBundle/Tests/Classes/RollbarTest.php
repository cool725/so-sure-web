...
class RollbarTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testShouldIgnore()
    {
        ...
        $this->assertTrue($rollbar->shouldIgnore(false, $e, null));
        $e = new \RollbarException(
            '',
            new \Symfony\Component\HttpKernel\Exception\MethodNotAllowedHttpException([], 'GET /login_check')
        );
        $this->assertTrue($rollbar->shouldIgnore(false, $e, null));
        ...
        $e = new \RollbarException(
            '',
            new \Symfony\Component\HttpFoundation\Exception\SuspiciousOperationException('Untrusted Host')
        );
        $this->assertTrue($rollbar->shouldIgnore(false, $e, null));
        $e = new \RollbarException(
            '',
            new \Symfony\Component\HttpKernel\Exception\BadRequestHttpException('Untrusted Host')
        );
        $this->assertTrue($rollbar->shouldIgnore(false, $e, null));
    }
}
