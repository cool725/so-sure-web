...
class Feature
{
    ...
    const FEATURE_UPDGRADE_POLICIES = 'allow-policy-upgarde';
    ...
    public static $features = [
        ...
        self::FEATURE_UPDGRADE_POLICIES,
    ];
    ...
    public static $descriptions = [
        ...
        self::FEATURE_STARLING => 'NOT IN USE - Starling integration',
        ...
        self::FEATURE_CARD_OPTION_WITH_BACS => 'Allow user to pay via Card in the funnel',
        self::FEATURE_CARD_SWAP_FROM_BACS => 'NOT IN USE - Allow user to swap from BACS to card',
        ...
        self::FEATURE_APP_FACEBOOK_USERFRIENDS_PERMISSION => 'NOT IN USE - Request user friends from Facebook. Requires permission from Facebook we lost in 2018 (but could re-request)',
        ...
        self::FEATURE_PAYMENTS_BCC => 'NOT IN USE - Bcc payment failure emails (and related) to bcc@so-sure.com',
        self::FEATURE_JUDO_RECURRING => 'NOT IN USE - Perform Judopay token payments with the \'recurring\' flag set.',
        ...
        self::FEATURE_APPLY_SIGN_UP_BONUS => 'NOT IN USE - Automatically apply any active sign-up bonuses to new users first policy',
        self::FEATURE_INVITE_PAGES_COMPETITION => 'NOT IN USE - Invite pages competition (Amazon voucher)',
        ...
        self::FEATURE_UPDGRADE_POLICIES => 'Allow users to upgrade policies',
    ];
