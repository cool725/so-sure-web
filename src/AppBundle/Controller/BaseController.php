...
abstract class BaseController extends Controller
{
    ...
    protected function getPhonesArray()
    {
        ...
        foreach ($items as $phone) {
            ...
            $phones[$phone->getMake()][$phone->getModel()][$phone->getId()] = ['memory' => $phone->getMemory(), 'featured' => $phone->isHighlight()];
            ...
            if ($phone->getAlternativeMake()) {
                ...
                $phones[$phone->getAlternativeMake()][$phone->getModel()][$phone->getId()] = ['memory' => $phone->getMemory(), 'featured' => $phone->isHighlight()];
