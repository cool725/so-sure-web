$('#claimsModal').on('show.bs.modal', function (event) {
  ...
  if (claim) {
    ...
    modal.find('#claims-detail-number-to-reach').text('');
    modal.find('#claims-detail-time-to-reach').text('');
    ...
    modal.find('#claims-detail-type-details').text('');
    modal.find('#claims-detail-bought').text('');
    modal.find('#claims-detail-phone-status').text('');
    modal.find('#claims-detail-warranty').text('');
    modal.find('#claims-detail-damage-proof-usages').html('');
    modal.find('#claims-detail-pictures-phone').html('');
    modal.find('#claims-detail-contacted').text('');
    modal.find('#claims-detail-network').text('');
    modal.find('#claims-detail-blocked').text('');
    modal.find('#claims-detail-reported').text('');
    modal.find('#claims-detail-reported-to').text('');
    modal.find('#claims-detail-theftloss-proof-usages').html('');
    modal.find('#claims-detail-proof-barrings').html('');
    modal.find('#claims-detail-proof-purchases').html('');
    modal.find('#claims-detail-crime-reference').text('');
    modal.find('#claims-detail-policy-report').text('');
