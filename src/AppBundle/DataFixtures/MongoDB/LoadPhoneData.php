...
class LoadPhoneData implements FixtureInterface
{
    public function load(ObjectManager $manager)
    {
        ...
        $this->newPhone($manager, 'Apple', 'iPhone 6', 7.29, 16, ['iPhone 6']);
        $this->newPhone($manager, 'Apple', 'iPhone 6', 7.29, 64, ['iPhone 6']);
        $this->newPhone($manager, 'Apple', 'iPhone 6', 7.29, 128, ['iPhone 6']);
        $this->newPhone($manager, 'Apple', 'iPhone 6 Plus', 7.29, 16, ['iPhone 6 Plus']);
        $this->newPhone($manager, 'Apple', 'iPhone 6 Plus', 7.29, 64, ['iPhone 6 Plus']);
        $this->newPhone($manager, 'Apple', 'iPhone 6 Plus', 7.29, 128, ['iPhone 6 Plus']);
        $this->newPhone($manager, 'Apple', 'iPhone 6s', 7.29, 16, ['iPhone 6s']);
        $this->newPhone($manager, 'Apple', 'iPhone 6s', 7.29, 64, ['iPhone 6s']);
        $this->newPhone($manager, 'Apple', 'iPhone 6s', 7.29, 128, ['iPhone 6s']);
        $this->newPhone($manager, 'Apple', 'iPhone 6s Plus', 7.29, 16, ['iPhone 6s Plus']);
        $this->newPhone($manager, 'Apple', 'iPhone 6s Plus', 7.29, 64, ['iPhone 6s Plus']);
        $this->newPhone($manager, 'Apple', 'iPhone 6s Plus', 7.29, 128, ['iPhone 6s Plus']);
        $this->newPhone($manager, 'Apple', 'iPhone 5s', 5.79, 16, ['iPhone 5s']);
        $this->newPhone($manager, 'Apple', 'iPhone 5s', 5.79, 32, ['iPhone 5s']);
        $this->newPhone($manager, 'Apple', 'iPhone 5s', 5.79, 64, ['iPhone 5s']);
        $this->newPhone($manager, 'Apple', 'iPhone 5c', 5.29, 8, ['iPhone 5c']);
        $this->newPhone($manager, 'Apple', 'iPhone 5c', 5.79, 16, ['iPhone 5c']);
        $this->newPhone($manager, 'Apple', 'iPhone 5c', 5.79, 32, ['iPhone 5c']);
        $this->newPhone($manager, 'Apple', 'iPhone 5', 5.29, 16, ['iPhone 5']);
        $this->newPhone($manager, 'Apple', 'iPhone 5', 5.79, 32, ['iPhone 5']);
        $this->newPhone($manager, 'Apple', 'iPhone 5', 5.79, 64, ['iPhone 5']);
        $this->newPhone($manager, 'Apple', 'iPhone 4s', 5.29, 8, ['iPhone 4s']);
        $this->newPhone($manager, 'Apple', 'iPhone 4s', 5.29, 16, ['iPhone 4s']);
        $this->newPhone($manager, 'Apple', 'iPhone 4s', 5.29, 32, ['iPhone 4s']);
        $this->newPhone($manager, 'Apple', 'iPhone 4s', 5.29, 64, ['iPhone 4s']);
        $this->newPhone($manager, 'Apple', 'iPhone 4', 5.29, 8, ['iPhone 4']);
        $this->newPhone($manager, 'Apple', 'iPhone 4', 5.29, 16, ['iPhone 4']);
        $this->newPhone($manager, 'Apple', 'iPhone 4', 5.29, 32, ['iPhone 4']);
        ...
        $this->newPhone($manager, 'Sony', 'Experia E3', 4.29, null, ['D2202', 'D2203', 'D2206', 'D2243', 'D2212']);
        $this->newPhone($manager, 'Sony', 'Experia L', 4.29, null, ['C2104']);
        $this->newPhone($manager, 'Sony', 'Experia M', 4.29, null, ['C1904', 'C1905', 'C2004']);
        $this->newPhone($manager, 'Sony', 'Experia M2 Aqua', 5.29, null, ['D2403', 'D2406']);
        $this->newPhone($manager, 'Sony', 'Experia M2', 5.29, null, ['D2303', 'D2305', 'D2306']);
        $this->newPhone($manager, 'Sony', 'Experia SP', 5.29, null, ['C5302', 'C5303', 'C5306', 'M35h', 'M35t']);
        $this->newPhone($manager, 'Sony', 'Experia T2 Ultra', 5.29, null, ['D5303', 'D5306', 'D5316', 'D5316N', 'D5322', 'D5322']);
        $this->newPhone($manager, 'Sony', 'Experia T3', 5.79, null, ['D5102', 'D5103', 'D5106']);
        $this->newPhone($manager, 'Sony', 'Experia Z Ultra', 5.79, null, ['C6802', 'C6806', 'C6833', 'C6843', 'SGP412', 'SOL24', 'XL39h']);
        $this->newPhone($manager, 'Sony', 'Experia Z', 5.79, null, ['C6602', 'C6603', 'C6606', 'C6616', 'L36h', 'SO-02E']);
        $this->newPhone($manager, 'Sony', 'Experia Z1 Compact', 5.79, null, ['D5503', 'M51w']);
        $this->newPhone($manager, 'Sony', 'Experia Z2', 5.79, null, ['D6502', 'D6503', 'D6543', 'SO-03F']);
        $this->newPhone($manager, 'Sony', 'Experia Z3', 5.79, null, ['401SO', 'D6603', 'D6616', 'D6643', 'D6646', 'D6653', 'SO-01G', 'SOL26', 'leo']);
        $this->newPhone($manager, 'Sony', 'Experia Z3 Compact', 6.29, null, ['D5803', 'D5833', 'SO-02G']);
        $this->newPhone($manager, 'Sony', 'Experia Z5', 7.29, null, ['501SO', 'E6603', 'E6653', 'SO-01H', 'SOV32']);
        $this->newPhone($manager, 'Sony', 'Experia Z5 Compact', 6.29, null, ['E5803', 'E5823', 'SO-02H']);
